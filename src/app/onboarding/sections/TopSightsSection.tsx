  ...
  return (
    <motion.button
      ...
      style={{
        ...
        boxShadow: selected
          ? '0 1px 0 rgba(255,255,255,0.04) inset, 0 14px 36px -22px rgba(196,162,106,0.45)'
          : '0 1px 0 rgba(255,255,255,0.04) inset, 0 16px 36px -22px rgba(0,0,0,0.55)',
      }}
    >
      {/* Photo (3:4 cuboid proportion) */}
      <div
        className="relative w-full overflow-hidden"
        style={{ aspectRatio: '3 / 4', background: 'rgba(255,255,255,0.025)' }}
      >
        {landmark.photo_url ? (
      ...
      <div className="p-3.5 flex flex-col gap-1.5">
        <div
          ...
          style={{ color: selected ? IVORY : 'rgba(241,236,227,0.92)' }}
        >
          {landmark.name}
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {[0, 1, 2, 3].map((i) => (
          <div
            ...
            style={{ background: SURFACE, border: BORDER }}
          >
            <div className="w-full" style={{ aspectRatio: '3 / 4', background: 'rgba(255,255,255,0.04)' }} />
            <div className="p-3.5 flex flex-col gap-2">
              <div className="h-3 rounded" style={{ background: 'rgba(255,255,255,0.06)', width: '70%' }} />
              <div className="h-2.5 rounded" style={{ background: 'rgba(255,255,255,0.04)', width: '90%' }} />
            </div>
          </div>
        ))}
      </div>
