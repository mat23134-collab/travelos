  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-black text-white mb-2 tracking-tight">Cookie Policy</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>
          <section>
            <h2 className="text-base font-bold text-white mb-2">1. What We Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-2">2. Essential Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-2">3. Preference Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-2">4. Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-2">5. Updating Your Choice</h2>
            <p>
