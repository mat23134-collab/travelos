    ...
    "recommendations": [
      {
        ...
        "otaPriceCompare": [
          ...
          { "source": "Agoda", "indicativeNightly": "€265–€310/night OR null when SOLD OUT/unknown", "note": "If no rooms are available, write exactly SOLD OUT for these dates. Otherwise cite availability evidence." },
...
- If no hotel: set basecamp.type="recommendations", omit booked{}, provide exactly 3 hotel recommendations in recommendations[] based on HOTEL_SEARCH_DATA (if available) or expertise. Each must include ALL keys shown in the sample recommendations[] object:
  ...
  • otaPriceCompare: mandatory — exactly 3 rows in this fixed order: Booking.com, Agoda, Airbnb. Booking.com and Agoda MUST include a numeric indicativeNightly only when HOTEL_SEARCH_DATA indicates rooms/rates for TRIP_HOTEL_DATES. If no rooms are available, indicativeNightly=null and note="SOLD OUT for these dates". Do not label unknown availability as available.
