    ...
    options: [
      {
        ...
        dailyAverage: '~¥800 / day (IC hops across zones)',
        tripTotalEstimate: '~¥2,400 for 3 days (indicative)',
        optionUrl: 'https://www.jreast.co.jp/e/',
        optionLinkLabel: 'JR East',
      ...
      },
      {
        ...
        dailyAverage: '~¥400 / day (short hops)',
        tripTotalEstimate: '~¥1,200 for 3 days (indicative)',
        optionUrl: 'https://www.tokyometro.jp/en/',
